  ...
  if user_id ~= nil then
    for k,v in pairs(garages) do
      ...
      if group then
        ...
        vRPclient.addCustomMarker(source,{27,x,y,z,0,0,0,2.5,2.5,0.7,255,255,0,125,150,1,0,0})
        vRPclient.addCustomMarker(source,{36,x,y,z,0,0,0,1.5,1.5,1.5,255,0,0,125,150,0,1,0})
