...
for k,v in pairs(cfg.cloakroom_types) do
  local menu = {name=lang.cloakroom.title({k}),css={top="75px",header_color="rgb(101,109,194)"}}
  menus[k] = menu
...
local function build_client_points(source)
  for k,v in pairs(cfg.cloakrooms) do
    ...
    if cloakroom and menu then
      ...
      -- cloakroom
      vRPclient.addCustomMarker(source,{21,x,y,z,0,0,0,1,1,1,255,0,0,255,150,1,0,0})
