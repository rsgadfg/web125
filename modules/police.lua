          ...
          vRP.getUserIdentity(nuser_id, function(identity)
            if identity then
              ...
              vRP.getUserBusiness(nuser_id, function(business)
				...
				local content = lang.police.identity.info({name,firstname,age,registration,phone,bname,bcapital,home,number,vRP.getUserGroupByType(nuser_id,"job")})
				vRPclient.setDiv(player,{"police_identity",".div_police_identity{ background-color: rgba(5,51,155,0.66); color: white; font-weight: bold; width: 300px; padding: 11px; margin: auto; margin-top: 100px; border-style: outset;}",content})
                  -- request to hide div
...
----------------------------------------
RegisterCommand('sss', function(player, args, rawCommand)
  vRPclient.getNearestPlayer(player,{10},function(nplayer)
    local nuser_id = vRP.getUserId(nplayer)
    if nuser_id ~= nil then
      vRPclient.notify(player,{lang.police.menu.askid.asked()})
...
RegisterCommand('store', function(player, args, rawCommand)
...
---- police check
RegisterCommand('jjj', function(player, args, rawCommand)
  vRPclient.getNearestPlayer(player,{5},function(nplayer)
    local nuser_id = vRP.getUserId(nplayer)
  local user_id = vRP.getUserId(player)
  if user_id ~= nil then
...
RegisterCommand('putinveh', function(player, args, rawCommand)
  vRPclient.getNearestPlayer(player,{10},function(nplayer)
    local nuser_id = vRP.getUserId(nplayer)
    if nuser_id ~= nil then
      vRPclient.isHandcuffed(nplayer,{}, function(handcuffed)  -- check handcuffed
...
RegisterCommand('outofveh', function(player, args, rawCommand)
  vRPclient.getNearestPlayer(player,{10},function(nplayer)
    local nuser_id = vRP.getUserId(nplayer)
    if nuser_id ~= nil then
      vRPclient.isHandcuffed(nplayer,{}, function(handcuffed)  -- check handcuffed
...
RegisterCommand('sizeweap', function(player, args, rawCommand)
  local user_id = vRP.getUserId(player)
  if user_id ~= nil then
    vRPclient.getNearestPlayer(player, {5}, function(nplayer)
      local nuser_id = vRP.getUserId(nplayer)
      if nuser_id ~= nil and vRP.hasPermission(nuser_id, "police.seize.weapons") then
        vRPclient.isHandcuffed(nplayer,{}, function(handcuffed)  -- check handcuffed
          if handcuffed then
            vRPclient.getWeapons(nplayer,{},function(weapons)
...
RegisterCommand('sizeitem', function(player, args, rawCommand)
  local user_id = vRP.getUserId(player)
  if user_id ~= nil then
    vRPclient.getNearestPlayer(player, {5}, function(nplayer)
      local nuser_id = vRP.getUserId(nplayer)
      if nuser_id ~= nil and vRP.hasPermission(nuser_id, "police.seize.items") then
        vRPclient.isHandcuffed(nplayer,{}, function(handcuffed)  -- check handcuffed
          if handcuffed then
